...
parser.add_argument('--save_folder', default="GDTLS_paper_more_samples", type=str, help="Folder to save your train or evaluation result")
parser.add_argument('--load_path', default="GDTLS_advanced_network_more_noise/GDTLS_200000.pt", type=str, help="None or directory to pretrained model")
